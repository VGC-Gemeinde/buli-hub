...
// protection on (the default), navy track (design/SPOILER-SCHUTZ.md §2.1).
// Flipping it writes the per-browser cookie — so the match page renders the
// same state server-side — and lifts the new value to the page state.
